document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll(".sidebar-item.has-submenu").forEach((item) => {
    item.addEventListener("click", function (e) {
      ...
      document
        .querySelectorAll(".sidebar-item.has-submenu")
        .forEach((other) => {
  ...
  document
    .querySelectorAll(
      ".sidebar-item[data-section], .sidebar-subitem[data-section]"
    )
    .forEach((item) => {
      item.addEventListener("click", function () {
        ...
        // Si es subitem, marcar también el padre como activo
        ...
        document.getElementById("usuarios-section").style.display =
          section === "usuarios" ? "" : "none";
        document.getElementById("solicitudes-section").style.display =
          section === "solicitudes" ? "" : "none";
        ...
        if (
          section === "solicitudes" &&
          typeof cargarSolicitudes === "function"
        ) {
          cargarSolicitudes();
        }
      });
